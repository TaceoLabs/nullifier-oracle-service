...
/// Represents an epoch of a merkle-root. Users will provide a `ChainEpoch` and retrieve the associated [`MerkleRoot`].
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Hash, Serialize)]
#[serde(transparent)]
pub(crate) struct ChainEpoch(u128);
