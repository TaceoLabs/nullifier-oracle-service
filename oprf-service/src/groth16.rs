...
pub struct Groth16Proof {
    ...
    #[serde(deserialize_with = "serde_compat::deserialize_bn254_g1")]
    pub(crate) a: ark_bn254::G1Affine,
    /// The `B` element in `G2`.
    #[serde(rename = "pi_b")]
    #[serde(serialize_with = "serde_compat::serialize_bn254_g2")]
    #[serde(deserialize_with = "serde_compat::deserialize_bn254_g2")]
...
pub struct Groth16VerificationKey {
    ...
    #[serde(serialize_with = "serde_compat::serialize_bn254_gt")]
    #[serde(deserialize_with = "serde_compat::deserialize_bn254_gt")]
    pub alpha_beta_gt: ark_bn254::Fq12,
    /// Used to bind the public inputs to the proof
    #[serde(rename = "IC")]
    #[serde(serialize_with = "serde_compat::serialize_bn254_g1_sequence")]
    #[serde(deserialize_with = "serde_compat::deserialize_bn254_g1_sequence")]
...
#[cfg(test)]
mod tests {
    use crate::groth16::{Groth16Proof, Groth16VerificationKey};
