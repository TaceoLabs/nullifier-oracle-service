...
pub struct Groth16VerificationKey {
    ...
    #[serde(serialize_with = "crate::serialize_bn254_gt")]
    #[serde(deserialize_with = "crate::deserialize_bn254_gt")]
    pub alpha_beta_gt: ark_bn254::Fq12,
    /// Used to bind the public inputs to the proof
    #[serde(rename = "IC")]
    #[serde(serialize_with = "crate::serialize_bn254_g1_sequence")]
    #[serde(deserialize_with = "crate::deserialize_bn254_g1_sequence")]
