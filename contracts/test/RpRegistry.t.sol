...
contract RpRegistryTest is Test {
    ...
    function aliceRound2Contribution() public pure returns (Types.Round2Contribution memory) {
    ...
    function bobRound2Contribution() public pure returns (Types.Round2Contribution memory) {
        Types.SecretGenCiphertext[] memory ciphers = new Types.SecretGenCiphertext[](3);
    ...
    function carolRound2Contribution() public pure returns (Types.Round2Contribution memory) {
        Types.SecretGenCiphertext[] memory ciphers = new Types.SecretGenCiphertext[](3);
