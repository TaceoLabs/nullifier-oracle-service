...
pub async fn start_nodes(
    ...
    [
        start_node(0, chain_ws_rpc_url, secret_manager0, key_gen_contract).await,
        start_node(1, chain_ws_rpc_url, secret_manager1, key_gen_contract).await,
        start_node(2, chain_ws_rpc_url, secret_manager2, key_gen_contract).await,
    ]
}
