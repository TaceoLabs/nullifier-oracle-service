...
pub struct OprfClientConfig {
    ...
    // /// Path to the OPRFNullifier circuit.
    // #[clap(long, env = "OPRF_CLIENT_NULLIFIER_CIRCUIT_PATH")]
    // pub nullifier_circuit_path: PathBuf,

    // /// Path to the OPRFQuery zkey.
    // #[clap(long, env = "OPRF_CLIENT_QUERY_CIRCUIT_PATH")]
    // pub query_circuit_path: PathBuf,
}
